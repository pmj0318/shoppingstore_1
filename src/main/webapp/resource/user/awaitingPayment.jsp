...
<head>
    ...
    <link href="<%=basePath%>resource/css/public.css" type="text/css" rel="stylesheet"/>
    <link rel="stylesheet" type="text/css" href="<%=basePath%>resource/css/base.css"/>
    <script type="text/javascript" src="<%=basePath%>resource/js/jquery_cart.js"></script>
    <link rel="stylesheet" type="text/css" href="<%=basePath%>resource/css/buyConfirm.css" />
        ...
        <ul class="fl 1h">
            <li class="fl">
                <div class="menu">
                    <div class="menu_hd">
                        <a href="#">
                            <img src="<%=basePath%>resource/images/pay/top_phone_icon.png" width="12px" height="16px" />
                            手机锡货
                        </a>
                        <b><em></em></b></div>
                    <div class="menu_bd">
    ...
    <div class="w">
        <div class="logo_v2013">
            <a href="#">
                ...
                <img src="<%=basePath%>resource/images/pay/slogan.jpg" width="170" height="50">
            </a>
        </div>
        ...
        <div id="cart_box" class="cart_box">
            <a id="cart" class="cart_link" href="#" rel="nofollow">
                ...
                <img src="<%=basePath%>resource/images/pay/shopping_icon.png" width="24" height="24" class="cart_gif">
                        ...
                        <div class="cart_con_single">
                            <div class="single_pic">
                                <a href="#" target="_blank" alt="兰蔻 (Lancome)根源补养洁颜啫哩 125ml">
                                    <img src="<%=basePath%>resource/images/pay/goods_img01.jpg" />
                                </a>
                            </div>
                                ...
                                <dd>
                                    <fieldset id="test4-input-input_tab1-input_tab2" style=" border:none;">
                                        <ul class="payment-list clearfix" >
                                            <li> <input class="input_tab1" name="myradio" id="r1" type="radio" checked="checked"/><label for="r1" ><img src="<%=basePath%>resource/images/pay/xhw.png" alt=""/></label></li>
                                            <li><input class="input_tab2" name="myradio" id="r2" type="radio" /><label for="r2" ><img src="<%=basePath%>resource/images/pay/zfb.png" alt=""/></label></li>
                                            <li> <input class="input_tab2" name="myradio" id="r3" type="radio" /><label for="r2" ><img src="<%=basePath%>resource/images/pay/yck.png" alt=""/></label></li>
                                            <li>  <input class="input_tab2" name="myradio" id="r4" type="radio" /><label for="r2" ><img src="<%=basePath%>resource/images/pay/zxzf.png" alt=""/></label></li>
                                        </ul>
                                        <div >
                                            <div id="test4_1">
...
<script src="<%=basePath%>resource/js/base.min.js"></script>

<script type="text/javascript" src="<%=basePath%>resource/js/buyConfirm.js"></script>
...
<div class="promise_box">
    <div class="w">
        <ul>
            <li><img src="<%=basePath%>resource/images/pay/promise_img01.jpg"><span>365天不打烊</span></li>
            <li><img src="<%=basePath%>resource/images/pay/promise_img02.jpg"><span>无理由退换货</span></li>
            <li><img src="<%=basePath%>resource/images/pay/promise_img03.jpg"><span>担保交易</span></li>
            <li><img src="<%=basePath%>resource/images/pay/promise_img04.jpg"><span>先行赔付</span></li>
            <li><img src="<%=basePath%>resource/images/pay/promise_img05.jpg"><span>支持定制</span></li>
        </ul>
    </div>
</div>
<div class="bottom-links">
    <ul class="clearfix cols">
        ...
        <li class="col">
            ...
            <ul class="clearfix bottom-links-items">
                <li>
                    <img src="<%=basePath%>resource/images/pay/weixin_big.jpg" />
                </li>
            </ul>
        </li>
        <li class="col">
            ...
            <ul class="clearfix bottom-links-items">
                <li><img src="<%=basePath%>resource/images/pay/icon_sina.png" /><a href="#">新浪微博</a></li>
                <li><img src="<%=basePath%>resource/images/pay/icon_tencent.png" /><a href="#">腾讯微博</a></li>
                <li><img src="<%=basePath%>resource/images/pay/icon_dou.png" /><a href="#">豆瓣小站</a></li>
                <li><img src="<%=basePath%>resource/images/pay/icon_weixin.png" /><a href="#">官方微信</a></li>
            </ul>
        </li>
...
<div class="footer_v2013 bottom-about">
    ...
    <p>
        <a href="#"><img src="<%=basePath%>resource/images/pay/bottom_img01.png"></a>
        <a href="#"><img src="<%=basePath%>resource/images/pay/bottom_img02.png"></a>
        <a href="#"><img src="<%=basePath%>resource/images/pay/bottom_img03.png"></a>
        <a href="#"><img src="<%=basePath%>resource/images/pay/bottom_img04.png"></a>
        <a href="#"><img src="<%=basePath%>resource/images/pay/bottom_img05.png"></a>
        <a href="#"><img src="<%=basePath%>resource/images/pay/bottom_img06.png"></a>
        <a href="#"><img src="<%=basePath%>resource/images/pay/bottom_img07.png"></a>
        <a href="#"><img src="<%=basePath%>resource/images/pay/bottom_img08.png"></a>
        <a href="#"><img src="<%=basePath%>resource/images/pay/bottom_img09.png"></a>
    </p>
</div>
<!-- 底部 -->
<div class="fixed-buttons">
    <ul>
        <li><a href="#" class="fixed-weixin"><img src="<%=basePath%>resource/images/pay/fixed_weixin.png" /><div class="weixin-pic"><img src="images/weixin_big.jpg"></div></a></li>
        <li><img id="imgBtn-to-top" src="<%=basePath%>resource/images/pay/back_top.png" /></li>
    </ul>
</div>
